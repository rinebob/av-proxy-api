...
| **`abc-run-pipeline-flowchart.md`** (this doc) | Mermaid flowcharts documenting the A/B/C pipeline visually with filenames and function names. | Internal + RS engineering |
