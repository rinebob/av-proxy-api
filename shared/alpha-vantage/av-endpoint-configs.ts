...
//   // Search symbols
  ...
  // ===== Technical Indicators — Hilbert Transform (on-demand, no Firestore) =====
  [AlphaVantageEndpoint.HT_TRENDLINE]: {
    id: AlphaVantageEndpoint.HT_TRENDLINE,
    name: 'Hilbert Transform - Trendline',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Instantaneous Trendline (smoothed price with reduced lag).',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-trendline',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
  ...
  [AlphaVantageEndpoint.HT_SINE]: {
    id: AlphaVantageEndpoint.HT_SINE,
    name: 'Hilbert Transform - SineWave',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Sine Wave (sine and lead-sine of cycle phase angle).',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-sine',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
  ...
  [AlphaVantageEndpoint.HT_TRENDMODE]: {
    id: AlphaVantageEndpoint.HT_TRENDMODE,
    name: 'Hilbert Transform - Trend vs Cycle',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Trend vs Cycle Mode classification.',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-trendmode',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
  ...
  [AlphaVantageEndpoint.HT_DCPERIOD]: {
    id: AlphaVantageEndpoint.HT_DCPERIOD,
    name: 'Hilbert Transform - DC Period',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Dominant Cycle Period (in bars).',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-dcperiod',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
  ...
  [AlphaVantageEndpoint.HT_DCPHASE]: {
    id: AlphaVantageEndpoint.HT_DCPHASE,
    name: 'Hilbert Transform - DC Phase',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Dominant Cycle Phase angle (0-360 degrees).',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-dcphase',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
  ...
  [AlphaVantageEndpoint.HT_PHASOR]: {
    id: AlphaVantageEndpoint.HT_PHASOR,
    name: 'Hilbert Transform - Phasor Components',
    provider: ApiProvider.ALPHA_VANTAGE,
    category: AvEndpointCategory.TECHNICAL_INDICATORS,
    apiEndpoint: '/query',
    method: HttpMethod.GET,
    description: 'Hilbert Transform - Phasor Components (In-Phase and Quadrature).',
    ttl: 0,
    symbolUsage: EndpointSymbolUsage.REQUIRED,
    firestorePath: '',
    documentationUrl: 'https://www.alphavantage.co/documentation/#ht-phasor',
    parameters: {
      symbol: {
        type: 'string',
        required: true,
