...
/**
 * Firestore collection names - MUST match the backend's FirestoreCollection enum
 * THIS IS A DIRECT COPY FROM functions\src\v2\common\firestore-collections.ts
 * Extend this enum as new collections are added
 */

export enum FirestoreCollection {

    ////////////// PASTE ALL COLLECTIONS FROM BACKEND HERE ////////////////
