...
export const MOCK_COMPANY_OVERVIEW_DATA: Record<string, AvCompanyOverview> = {
  ...
  'NFLX': {
    ...
    LatestQuarter: '2025-03-31',
    MarketCapitalization: '569894896000',
    EBITDA: '11453826000',
    PERatio: '63.26',
    PEGRatio: '2.532',
    BookValue: '56.45',
    ...
    TrailingPE: '63.26',
    ForwardPE: '53.76',
    PriceToSalesRatioTTM: '14.19',
    PriceToBookRatio: '23.72',
    EVToRevenue: '14.35',
    EVToEBITDA: '21.3',
    Beta: '1.589',
    '52WeekHigh': '1341.15',
    '52WeekLow': '587.04',
    '50DayMovingAverage': '1181.44',
    '200DayMovingAverage': '948.4',
    SharesOutstanding: '425571000',
    SharesFloat: '422759000',
    PercentInsiders: '0.554',
    PercentInstitutions: '86.738',
    DividendDate: 'None',
    ExDividendDate: 'None'
  }
} as const;
